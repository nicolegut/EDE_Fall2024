...
O3plot7 <- ggplot(EPAair, aes(x = Date, y = Ozone)) +
  geom_hline(yintercept = 50, lty = 2) + #horizontal line at 50, lty 2 dashde
  geom_hline(yintercept = 100, lty = 2) + #another horizontal
  geom_point(alpha = 0.5, size = 1.5) + #points, alpha is the transparency
  geom_text(x = as.Date("2020-01-01"), y = 45, label = "good", hjust = 1, fontface = "bold") +   # adding text to plot, hjust = 1 means left align, point will be over the date at a y value of 45
  ...
  ylab(expression("O"[3]* " AQI Value")) + #setting range of dates plotted and the type of label on the axis
