...
Nutrientplot4 <-
  ggplot(PeterPaul.chem.nutrients.gathered, aes(x = lakename, y = concentration)) +
  geom_dotplot(aes(color = nutrient, fill = nutrient), binaxis = "y", binwidth = 1, #stacking observations over y
               stackdir = "center", position = "dodge", dotsize = 2) #stacking points in the center/ dots at the same conc will go to the side --> dodge
print(Nutrientplot4)
