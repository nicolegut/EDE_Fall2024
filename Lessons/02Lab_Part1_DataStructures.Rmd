...
#denies values within the vectors --> now opposite
!vector3
...
matrix1[4, 1] # element from row 4, column 1

matrix1[4,  ] # provides all elements on row 4 

matrix1[ , 3] # provides all elements in column 3

matrix1[c(12, 14)] # provides values

matrix1[c(12:14)] # values between 12 and 14

matrix1[2:4, 1:3] # creates mini matrix from initial
...
# replacing value of the 4th object
list1[[4]] = 44
```
...
names(dataframe1) <- c("ID","Color","Passed"); View(dataframe1) # comment out view funct before knitting
