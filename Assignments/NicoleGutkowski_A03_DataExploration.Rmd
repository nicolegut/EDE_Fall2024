...
> Answer: The six most commonly studied species in the dataset are the Honey Bee, Parasistic Wasp, Buff Tailed Bumblebee, Carniolan Honey Bee, Bumble Bee, and Italian Honeybee. These species are all pollinators. They are of interest over other insects due to essential nature in plant growth. (FINISH!!)
...
> Answer: A violin plot depends on differing data densities between our groups of interest. A boxplot can create visualizations with fewer data points, making it effective in our case.
