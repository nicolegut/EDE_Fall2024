...
```{r echo=FALSE, fig.align='left', fig.height=4, fig.width=6, warning=FALSE, fig.cap='Ozone Levels by Month (2018)'}
...
ozonet1 <- epa_data %>% 
  ...
  ggplot(aes(x = factor(Month, levels = 1:12, labels = month.abb),
             y = Ozone))+
  geom_boxplot()+
  labs(x = "Month", y = expression(Concentration~(mu*g/m^3)), title = "Monthly Ozone Concentrations (2018)")
ozonet1

```

```{r echo=FALSE, fig.align='left', fig.height=4, fig.width=6, warning =FALSE, fig.cap='Ozone Levels by Month (2019)'}
ozonet2 <- epa_data %>% 
  filter(Year == 2019) %>% 
  ggplot(aes(x = factor(Month, levels = 1:12, labels = month.abb),
             y = Ozone))+
  geom_boxplot()+
  labs(x = "Month", y = expression(Concentration~(mu*g/m^3)), title = "Monthly Ozone Concentrations (2019)")
ozonet2
...
[https://github.com/nicolegut/EDE_Fall2024.git](https://github.com/nicolegut/EDE_Fall2024.git)
